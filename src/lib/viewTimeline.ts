 ...
 * view-screen link) into the timeline mode and flat 1-based scrub index it
 * names — e.g. `#chapter-20` → `{ mode: 'book', index: 20 }`. Returns null
 * for a missing, malformed, or non-positive fragment; out-of-range indices
 * are left for the caller to clamp, same as a manual scrub.
 */
